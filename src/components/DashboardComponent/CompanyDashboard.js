...
import {API_BASE_URL,API_BASE_URL_EMP,ACCESS_TOKEN} from '../../../src/constants/index';
...
class CompanyDashboard extends React.Component {
    ...
    getprojectcount() {
        const url = API_BASE_URL+'/countproject';
    ...
    console.log(this.state.value)
      ...
      getQacount() {
        const url = API_BASE_URL_EMP+'/getTotalQaCount';
        axios.get(url,{ headers: { Authorization: 'Bearer ' + localStorage.getItem(ACCESS_TOKEN)}})
      ...
      getDevelopercount() {
        const url = API_BASE_URL_EMP+'/getdevelopercount';
        axios.get(url,{ headers: { Authorization: 'Bearer ' + localStorage.getItem(ACCESS_TOKEN)}})
      ...
      getPmcount() {
        const url = API_BASE_URL_EMP+'/getTotalPmCount';
        axios.get(url,{ headers: { Authorization: 'Bearer ' + localStorage.getItem(ACCESS_TOKEN)}})
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <Row>
                    ...
                    <Col span={1} >
                        <div id="components-dropdown-demo-dropdown-button" style={{ marginLeft: "-2.1em" }}>
                            <DashboardConfig dashconfig={this.visibledash}/>
                        </div>
              ...
              {this.state.name==="Defect" ? <DeveloperDefectDetail/>:''} 
